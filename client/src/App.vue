    ...
    <nav class="nav">
      <div class="container">
        <div class="nav-menu">
          ...
          <ul class="nav__list" v-if="showNav">
      ...
      <div class="container">
        <div class="nav-menu">
          ...
          <ul class="nav__list" v-else>
            ...
            <li class="nav__list-item">
              <button class="sign" @click="logout">logout</button>
            </li>
          </ul>
        </div>
      </div>
  ...
  methods: {
    checkAuthentication() {
      ...
      if (token) {
        ...
        // Fetch the user nickname, you might need to decode the token or fetch from an API
        this.userNickname = localStorage.getItem('userNickname') || 'User'; // Simplified for this example
      }
    },
    logout() {
      ...
      <footer class="footer">
          <div class="container">
            <div class="footer-content">
              ...
              <h3>About Us</h3>
              <p>wertyuiolkjhgf sdfghjkgf ffsdf dfsfsdf gdfgdfgdfg dsfdfdsfs gsgdsf</p>
            </div>
            <div class="footer-section">
              <h3>Quick Links</h3>
              <ul>
